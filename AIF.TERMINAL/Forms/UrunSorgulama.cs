...
namespace AIF.TERMINAL.Forms
{
    public partial class UrunSorgulama : form_Base
    {
        ...
        private void UrunSorgulama_Load(object sender, EventArgs e)
        {
            ...
            vScrollBar1.Maximum = dtgProductDetails.RowCount;
        ...
        private void GetDetails(string itemcode, string barkod)
        {
            ...
            {
                resp = aIFTerminalServiceSoapClient.GetProductsByBarCodeWithWhsDetails(Giris._dbName, itemcode, Giris.mKodValue);
            }
            else
            {
                resp = aIFTerminalServiceSoapClient.GetProductsByItemCodeWithWhsDetails(Giris._dbName, itemcode, Giris.mKodValue);
