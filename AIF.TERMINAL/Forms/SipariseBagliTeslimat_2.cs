    ...
    public partial class SipariseBagliTeslimat_2 : form_Base
    {
        ...
        private void btnDetails_Click(object sender, EventArgs e)
        {
            ...
            if (partili != "Y")
            {
                ...
                if (resp._list != null)
                {
                    ...
                    list.Add(dtDetails.Rows[currentRow - 1]["DepoYeriId"].ToString());
                    list.Add(dtDetails.Rows[currentRow - 1]["DepoYeriAdi"].ToString());
        ...
        private void dtgDetails_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                e.RowIndex >= 0)
            {
                ...
                if (senderGrid.Columns[e.ColumnIndex].Name == "btnDetail")
                {
                    ...
                    list.Add(dtDetails.Rows[e.RowIndex]["DepoYeriId"].ToString());
                    list.Add(dtDetails.Rows[e.RowIndex]["DepoYeriAdi"].ToString());
        ...
        private void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var resp1 = aIFTerminalServiceSoapClient1.AddOrUpdateOrders(Giris._dbName, orders);
