...
namespace AIF.TERMINAL.Forms
{
    public partial class KonteynerYapma_2 : form_Base
    {
        ...
        DataTable dtKonteynerYapmaListesiDetay = new DataTable();
        List<KonteynerIcindenSilinenler> konteynerIcindenSilinenlers = new List<KonteynerIcindenSilinenler>();
