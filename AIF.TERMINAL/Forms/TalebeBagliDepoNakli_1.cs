...
namespace AIF.TERMINAL.Forms
{
    public partial class TalebeBagliDepoNakli_1 : form_Base
    {
        ...
        DataTable dtcmbWarehouseSource = new DataTable();
        DataTable dtcmbWarehouseTarget = new DataTable();
        string formName = "";
        ...
        private void btnList_Click(object sender, EventArgs e)
        {
            ...
            if (Giris.genelParametreler.DepoCalismaTipi == "1")
            {
                aIFTerminalServiceSoapClient.GetInventoryTransferRequest(Giris._dbName, startDate, endDate, fromwhsCode, towhsCode, Giris.whsCodes.ToArray(), Giris._userCode, Giris.mKodValue);
            }
            else if (Giris.genelParametreler.DepoCalismaTipi == "2")
            {
        ...
        List<InventoryTransferList> InventoryTransferLists = new List<InventoryTransferList>();
        DataTable dtInventoryTransfer = new DataTable();
