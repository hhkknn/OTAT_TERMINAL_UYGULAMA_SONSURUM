    ...
    public partial class TalebeBagliDepoNakli_2 : form_Base
    {
        ...
        private void GridDuzenle()
        {
            if (formYukleniyor)
            {
                ...
                dtgDetails.Columns["Serili"].Visible = false;
                dtgDetails.Columns["DepoYeriId"].Visible = false;
                dtgDetails.Columns["HDepoYeriId"].Visible = false;
                //dtgDetails.Columns["PaletNo"].Visible = false;//kod eski oldugundan bu alan servisten gelmiyor. bu yüzden kapattım
                ...
                if (Giris.mKodValue == "30TRMN")
                {
                    ...
                    dtgDetails.Columns["DepoYeriAdi"].HeaderText = "KAYNAK D.YERI";
                    dtgDetails.Columns["HDepoYeriAdi"].HeaderText = "HEDEF D.YERI";
                }
                ...
                dtgDetails.Columns["OlcuBirimiAdi"].ReadOnly = true;
                ...
                #region kod eski oldugundan bu alan servisten gelmiyor. bu yüzden kapattım
                //if (Giris.genelParametreler.olcuBirimTuru == "1")
                //{
                //    dtgDetails.Columns["OlcuBirimi"].DisplayIndex = 4;
                //}
                //else if (Giris.genelParametreler.olcuBirimTuru == "2")
                //{
                //    dtgDetails.Columns["OlcuBirimiAdi"].DisplayIndex = 4;
                //} 
                #endregion
                ...
                dtgDetails.Columns["OlcuBirimiAdi"].HeaderText = "BR";
                ...
                dtgDetails.Columns["KalemKodu"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["OlcuBirimi"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["OlcuBirimiAdi"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["Miktar"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["ToplananMiktar"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["DepoMiktar"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["HedefDepo"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["OnaydaBekleyenMiktar"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dtgDetails.Columns["DepoYeriAdi"].AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader;
                dtgDetails.Columns["HDepoYeriAdi"].AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader;

                int val = dtgDetails.Columns["BelgeNumarasi"].Width + dtgDetails.Columns["KalemKodu"].Width + dtgDetails.Columns["OlcuBirimi"].Width + dtgDetails.Columns["OlcuBirimiAdi"].Width + dtgDetails.Columns["Miktar"].Width + dtgDetails.Columns["ToplananMiktar"].Width + dtgDetails.Columns["DepoMiktar"].Width + dtgDetails.Columns["HedefDepo"].Width + dtgDetails.Columns["OnaydaBekleyenMiktar"].Width + dtgDetails.Columns["DepoYeriAdi"].Width + dtgDetails.Columns["HDepoYeriAdi"].Width;

                if (dtgDetails.Width < val)
                {
                    dtgDetails.Columns["KalemAdi"].AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader;
                    dtgDetails.RowsDefaultCellStyle.WrapMode = DataGridViewTriState.True;
                }
                ...
                //dtgDetails.Columns["HDepoYeriAdi"].AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader;
                //dtgDetails.Columns["KalemKodu"].AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader;
                ////dtgDetails.Columns["KalemAdi"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;

                ////dtgDetails.Columns["KalemAdi"].Width = dtgDetails.Width - dtgDetails.Columns["KalemKodu"].Width - dtgDetails.Columns["Miktar"].Width - dtgDetails.Columns["OnaydaBekleyenMiktar"].Width - dtgDetails.Columns["ToplananMiktar"].Width - dtgDetails.Columns["OlcuBirimi"].Width - dtgDetails.Columns["ToplananMiktar"].Width - dtgDetails.Columns["HedefDepo"].Width;
            ...
            try
            {
                ...
                foreach (DataRow items in dtDetails.Rows)
                {
                    ...
                    inventoryGenEntryLines1.Add(new InventoryGenEntryLines
                    {
                        ...
                        BinCode_from = Giris.genelParametreler.DepoYeriCalisir == "Y" ? items["DepoYeriId"].ToString() : "",
                        BinCode_to = Giris.genelParametreler.DepoYeriCalisir == "Y" ? items["HDepoYeriId"].ToString() : "",
                    });
                ...
                if (Giris.mKodValue == "10TRMN" || Giris.mKodValue == "30TRMN")
                {
                    try
                    {
                        AIFTerminalServiceSoapClient aIFTerminalServiceSoapClient = new AIFTerminalServiceSoapClient();
                ...
                var resp1 = Giris.genelParametreler.TalebeBaglidaOrjinalOlustur == "N" ? aIFTerminalServiceSoapClient1.AddOrUpdateStockTransferDraft(Giris._dbName, inventoryGenEntry) : Giris.genelParametreler.TalebeBaglidaOrjinalOlustur == "" ? aIFTerminalServiceSoapClient1.AddOrUpdateStockTransferDraft(Giris._dbName, inventoryGenEntry) : aIFTerminalServiceSoapClient1.AddOrUpdateStockTransfer(Giris._dbName, inventoryGenEntry);
