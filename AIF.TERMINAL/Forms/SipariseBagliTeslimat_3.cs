...
namespace AIF.TERMINAL.Forms
{
...

    {
        ...
        DataTable BatchInWarehouseDt = new DataTable();
        ...
        private void SipariseBagliTeslimat_3_Load(object sender, EventArgs e)
        {
            ...
            {
                var existrecord = BelgesizMalCikisi_1.inventoryGenExitBatches.Where(x => x.LineNumber == BelgesizMalCikisi_1.currentRow).ToList();
                ...
                var sum = BelgesizMalCikisi_1.inventoryGenExitBatches.Where(x => x.LineNumber == BelgesizMalCikisi_1.currentRow).Sum(y => y.BatchQuantity);
            ...
            var resp = aIFTerminalServiceSoapClient.GetBatchByItemCode(Giris._dbName, warehouse, txtItemCode.Text, Giris.mKodValue);
        ...
        private void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            else if (type == "60")
            {
                ...
                BelgesizMalCikisi_1.inventoryGenExitBatches.RemoveAll(x => x.LineNumber == BelgesizMalCikisi_1.currentRow);
