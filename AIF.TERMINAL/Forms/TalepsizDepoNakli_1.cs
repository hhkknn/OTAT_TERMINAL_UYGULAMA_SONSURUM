            ...
            try
            {
                ...
                foreach (DataRow items in dtProducts.Rows)
                {
                    ...
                    inventoryGenEntryLines1.Add(new InventoryGenEntryLines
                    {
                        ...
                        BinCode_from = Giris.genelParametreler.DepoYeriCalisir == "Y" ? dtgProducts.Rows[index].Cells["KDepoYeriId"].Value.ToString() : "",
                        BinCode_to = Giris.genelParametreler.DepoYeriCalisir == "Y" ? dtgProducts.Rows[index].Cells["HDepoYeriId"].Value.ToString() : "",
                    });
                ...
                {
                    resp1 = aIFTerminalServiceSoapClient1.AddOrUpdateStockTransfer_3(Giris._dbName, inventoryGenEntry);
                }
                else
                {
                    resp1 = aIFTerminalServiceSoapClient1.AddOrUpdateStockTransfer(Giris._dbName, inventoryGenEntry);
                }
