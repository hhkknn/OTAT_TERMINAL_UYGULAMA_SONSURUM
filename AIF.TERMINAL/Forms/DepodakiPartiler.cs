...
namespace AIF.TERMINAL.Forms
{
    public partial class DepodakiPartiler : form_Base
    {
        ...
        //end font 
        string type = "";
        public DepodakiPartiler(string _type, DataTable _dtBatchList, TextBox _textBoxQty, TextBox _textboxBatchNum, string _formName)
        {
            InitializeComponent();
        ...
        TextBox textboxBatchNum = new TextBox();
        TextBox textboxQty = new TextBox();

        DataTable dtBatchList = new DataTable();
        DataTable dtBatchListTemp = new DataTable();
        string formName = "";
