...
namespace AIF.TERMINAL.Forms
{
    public partial class TalebeBagliDepoNakli_3_Kabul : form_Base
    {
        ...
        private void TalebeBagliDepoNakli_3_Load(object sender, EventArgs e)
        {
            ...
            var existrecord = TalebeBagliDepoNakli_2_Kabul.inventoryGenEntryBatches.Where(x => x.DocEntry == TalebeBagliDepoNakli_2_Kabul.DocEntry && x.LineNumber == TalebeBagliDepoNakli_2_Kabul.currentRow).ToList();
            ...
            var sum = TalebeBagliDepoNakli_2_Kabul.inventoryGenEntryBatches.Where(x => x.DocEntry == TalebeBagliDepoNakli_2_Kabul.DocEntry && x.LineNumber == TalebeBagliDepoNakli_2_Kabul.currentRow).Sum(y => y.BatchQuantity);
        ...
        private void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            if (type == "1250000001")
            {
                ...
                TalebeBagliDepoNakli_2_Kabul.inventoryGenEntryBatches.RemoveAll(x => x.LineNumber == TalebeBagliDepoNakli_2_Kabul.currentRow && x.DocEntry == TalebeBagliDepoNakli_2_Kabul.DocEntry);
